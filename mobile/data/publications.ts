// Publications data for mobile app
...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    publication:
      "Food Chemistry / related color analysis work (as cited in thesis)",
    year: "2022",
    reference:
  ...
  },
  {
    ...
    publication:
      "Study on using YOLOv5 for mold detection (as cited in thesis, [11])",
    year: "2021",
    reference:
  ...
  },
  {
    ...
    type: "local",
    title:
      "Post-harvest fish handling practices of small-scale fisherfolk in Rosario, Cavite",
    authors: "Ching et al.",
  ...
  },
  {
    ...
    type: "local",
    title:
      "Microbial quality of fish products and contact surfaces in Philippine wet markets",
