...
export default function SellerVouchersScreen({ onNavigate, onBack }: Props) {
  const { user } = useAuth();
  ...
  const loadVouchers = async () => {
    try {
      setLoading(true);
      // Don't pass seller_id - backend will use current user's ID from auth token
      const data = await listVouchers(API_BASE_URL, "all");
      setVouchers(data);
    } catch (err) {
    ...
    return (
      ...
      >
        ...
        <Text style={{ fontSize: 14, color: "#94A3B8", marginBottom: 8 }}>
          Store voucher - applies only to your products
        </Text>
  ...
  return (
    <View style={ecommerceStyles.container}>
      <View style={ecommerceStyles.header}>
        ...
        <Text style={ecommerceStyles.headerTitle}>My Vouchers</Text>
        <TouchableOpacity
      ...
      >
        ...
        <Text style={{ fontSize: 12, color: "#94A3B8", marginLeft: 8, flex: 1 }}>
          Vouchers you create can only be applied to products in your store.
        </Text>
      </View>
      ...
      {loading ? (
        ...
        >
          ...
          <Text style={{ fontSize: 14, color: "#64748B", marginTop: 8, textAlign: "center", paddingHorizontal: 32 }}>
            Create vouchers to offer discounts on your store products
          </Text>
          <TouchableOpacity
            style={{
      ...
      <Modal visible={modalVisible} animationType="slide" transparent>
        ...
        >
          ...
          >
            ...
            <View style={{ flexDirection: "row", gap: 12, marginBottom: 16 }}>
              <TouchableOpacity
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    form.discountType === "percentage" ? "#10B981" : "#334155",
                  alignItems: "center",
                }}
              ...
              >
                <Text
                  style={{
                    color:
                      form.discountType === "percentage" ? "#fff" : "#94A3B8",
                    fontWeight: "600",
                  }}
                >
                  Percentage (%)
              ...
              <TouchableOpacity
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    form.discountType === "fixed" ? "#10B981" : "#334155",
                  alignItems: "center",
                }}
              ...
              >
                <Text
                  style={{
                    color: form.discountType === "fixed" ? "#fff" : "#94A3B8",
                    fontWeight: "600",
                  }}
                >
                  Fixed (₱)
            ...
            <TouchableOpacity
              style={[ecommerceStyles.primaryButton, { marginTop: 8, backgroundColor: "#10B981" }]}
              onPress={handleSave}
              disabled={saving}
            >
              {saving ? (
